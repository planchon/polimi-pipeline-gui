...
export default class Flood extends React.Component {
    constructor(props) {
        super(props)
    ...
    get_comming_image() {
        fetch("http://localhost:8080/flood/in").then(data => data.json())
    ...
    run_model() {
        ...
        .then(data => {
            ...
            socket.emit("join", {room: data["socket"], service: "flood"})
