...
export default class MemeFilter extends React.Component {
    constructor(props) {
        super(props)
    ...
    get_comming_image() {
        fetch("http://localhost:8080/meme/in").then(data => data.json())
    ...
    run_model() {
        ...
        .then(data => {
            ...
            socket.emit("join", {room: data["socket"], service: "meme"})
